...
namespace Octopus.Server.Extensibility.IssueTracker.AzureDevOps
{
    ...
    public struct ExtResult<T> : IExtResult
    {
        ...
        public static ExtResult<T> Failure(string reason, T partialValue = default)
        {
    ...
    public static class ExtResult
    {
        ...
        public static ExtResult<T> Failure<T>(string reason, T partialValue) => ExtResult<T>.Failure(reason, partialValue);
